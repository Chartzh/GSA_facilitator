...
async function test() {
  ...
  // Parse CATALOG_SKILL_BADGES directly from catalogData.ts
  ...
  const endIdx = catText.indexOf('export const JULY_ARCADE_GAMES');
  const section = catText.slice(startIdx, endIdx);
